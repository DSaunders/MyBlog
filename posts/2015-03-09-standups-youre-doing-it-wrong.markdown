...
If you only have time to read one article, read <a href="https://www.pandastrike.com/posts/20150304-agile" target="_blank">this</a> by PandaStrike instead, it's much better than mine!
...
<ul>
	...
	<li>What can you do to help me</li>
	<li>What are the project priorities, have they changed?</li>
	<li>Are there any blockers we need to allocate to somebody to deal with (e.g. we’re still waiting for the client to provide images, or we’re out of coffee)</li>
	<li>Is there anything important that the whole team needs to know (e.g. the build server down for maintenance at 3pm, or there are chocolate digestives in the kitchen)</li>
	<li>Are there any conversations that we need to have after this? If so, who is involved?</li>
</ul>


Let me know on <a href="https://twitter.com/DaveJSaunders" target="_blank">Twitter</a> whether you agree with me, or think i’m missing the point entirely!